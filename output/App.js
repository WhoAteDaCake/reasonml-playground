...
var match = Data.load(Data.treeKey);
...
function make() {
  ...
  newrecord[/* didUpdate */5] = (function (param) {
      ...
      Data.save(Data.treeKey, newSelf[/* state */1][/* root */0]);
      return /* () */0;
    });
  newrecord[/* render */9] = (function (param) {
      var send = param[/* send */3];
      var state = param[/* state */1];
      var match = Tree.find(state[/* root */0], state[/* basePath */2]);
      var root = match ? match[0] : state[/* root */0];
        ...
        return React.createElement("div", {
                    ...
                    className: "row"
                        ...
                        className: "content"
                            ...
                            className: "pad",
                            onClick: (function () {
                                return Curry._1(send, /* UpdateBasePath */Block.__(3, [item[/* path */2]]));
                              })
      ...
      return React.createElement("div", {
                  className: "root"
                }, ReasonReact.element(/* None */0, /* None */0, Fragment.make(/* array */[$$Array.of_list(List.map(renderItem, root[/* children */3]))])));
    });
